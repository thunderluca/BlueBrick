...
namespace BlueBrick.MapData
{
    ...
    public class Map : IXmlSerializable
    {
        ...
        private string mGeneralInfoWatermark = string.Empty;
        ...
        public void Draw(Graphics g, RectangleF areaInStud, double scalePixelPerStud, bool drawSelection)
        {
            ...
            {
                mLayers[i].Draw(g, areaInStud, scalePixelPerStud, drawSelection);
            }
        }
        ...
        public void DrawWatermark(Graphics g, RectangleF areaInStud, double scalePixelPerStud)
        {
            ...
            var generalInfoSize = g.MeasureString(GeneralInfoWatermark, Settings.Default.WatermarkFont);
            var x = (float)(areaInStud.Width * scalePixelPerStud) - generalInfoSize.Width;
            var y = (float)(areaInStud.Height * scalePixelPerStud) - generalInfoSize.Height;
        ...
        public bool HandleMouseDown(MouseEventArgs e, PointF mouseCoordInStud, ref Cursor preferedCursor)
        {
            ...
            if (mSelectedLayer == null || !mSelectedLayer.HandleMouseDown(e, mouseCoordInStud, ref preferedCursor))
            {
                return false;
            }
        ...
        public bool HandleMouseMoveWithoutClick(MouseEventArgs e, PointF mouseCoordInStud, ref Cursor preferedCursor)
        {
            ...
            mLayerThatHandleMouse = mSelectedLayer.HandleMouseMoveWithoutClick(e, mouseCoordInStud, ref preferedCursor) ? mSelectedLayer : null;
            return mLayerThatHandleMouse != null;
        }
        ...
        {
            // we ask if the selected layer want to handle this mouse down event
            return mLayerThatHandleMouse?.MouseDown(e, mouseCoordInStud) ?? false;
        }
        ...
        {
            return mLayerThatHandleMouse?.MouseMove(e, mouseCoordInStud, ref preferedCursor) ?? false;
        }
